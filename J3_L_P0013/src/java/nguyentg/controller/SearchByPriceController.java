...
public class SearchByPriceController extends HttpServlet {
     ...
     */
    static Logger log = Logger.getLogger(SearchByPriceController.class.getName());
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            request.getSession().setAttribute("priceMin", Integer.parseInt(priceMin.substring(1)));
            request.getSession().setAttribute("priceMax", Integer.parseInt(priceMax.substring(1)));
