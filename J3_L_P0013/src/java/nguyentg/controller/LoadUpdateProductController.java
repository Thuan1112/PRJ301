 ...
 * @author Nguyen
 */
public class LoadUpdateProductController extends HttpServlet {
     ...
     */
    static Logger log = Logger.getLogger(LoadUpdateProductController.class.getName());
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String id= request.getParameter("updateProductID");
        try {
