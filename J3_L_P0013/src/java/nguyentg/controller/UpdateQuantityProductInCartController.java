 ...
 * @author Nguyen
 */
public class UpdateQuantityProductInCartController extends HttpServlet {
     ...
     */
    static Logger log = Logger.getLogger(UpdateQuantityProductInCartController.class.getName());
